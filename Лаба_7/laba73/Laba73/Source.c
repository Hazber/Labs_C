...
void display(void)
{
	...
	if (GetAsyncKeyState(VK_LEFT))  angle += 0.5; // Кнопки Влево и вправо крутят фигуру! 
...
int main(int argc, char* argv[])
{
	...
	//Первый параметр представляет из себя указатель на количество аргументов
	//в командной строке, а второй - указатель на массив аргументов. Обычно эти значения берутся из главной функции программы:
	//int main(int argc, char *argv[]).
